...
<form class="row g-3">
  ...
  <input type="text" class="form-control bg-dark text-white border-0" placeholder="Password" required onChange={(e)=>{setprincipal(e.target.value)}}/>
  ...
  <div class="col-md-4">
  <div class="form-floating">
  <input type="email" class="form-control bg-dark text-white border-0" placeholder="Password" required onChange={(e)=>{setemail(e.target.value)}}/>
  ...
  <div class="col-md-4">
  <div class="form-floating">
  <input type="tel" class="form-control bg-dark text-white border-0" placeholder="Password" onChange={(e)=>{setcontact(e.target.value)}}/>
  <label class="text-secondary fw-bold">Contact number</label>
</div>
  </div>
  <div class="col-md-9">
  <div class="form-floating">
  <input type="text" class="form-control bg-dark text-white border-0" placeholder="Password" onChange={(e)=>{setschool(e.target.value)}}/>
  <label class="text-secondary fw-bold">School name</label>
</div>
  </div>
  <div class="col-md-3">
  <div class="form-floating">
  <input type="" class="form-control bg-dark text-white border-0" placeholder="Password" onChange={(e)=>{setcode(e.target.value)}}/>
  ...
  <div class="col-md-12">
  <div class="form-floating">
  <textarea type="text" class="form-control bg-dark text-white border-0" rows="4" cols="10" placeholder="Password" onChange={(e)=>{setaddress(e.target.value)}}/>
...
<div className="container-fluid bg-black border-top border-secondary fixed-bottom">
