...
<nav className="navbar bg-black border-bottom border-top">
 ...
 <form className="pb-lg-5 pt-lg-4 px-2 pb-5 pt-4">
   <div className="form-floating">
     <input type="text" className="form-control bg-dark text-white border-0" placeholder="Name" onChange={(e)=>{
      setname(e.target.value)
    }}/>
     <label className="text-secondary fw-bold">Name of the Board Member</label>
   </div>
   <div className="form-floating mt-3">
     <input type="text" className="form-control bg-dark text-white border-0" placeholder="Posting" onChange={(e)=>{
