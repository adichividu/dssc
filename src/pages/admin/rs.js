...
const[schools]=useCollectionData(db.collection("schools"))
 ...
 <div className=" container justify-content-center" style={{width:'40em'}}>
  {schools && schools.map(school => 
      school.approved===false?<div className="col-sm-12 col-md-6 col-lg-4 my-2">
        <div className="border border-bottom pb-3 px-3">
          <h1 className="navbar-brand my-0 h1 fw-bolder text-white my-3" align="left">School Name:-</h1>
        ...
        <img src={school.logo} alt="logo" style={{width:"33.5em", height:"33.5em"}}/>
        </div>
      ...
      <div class="d-grid my-3">
        <button class="btn btn-lg text-black fw-bold bg-warning border-0 py-2" type="button" onClick={async()=>{
    ...
    <div className="border border-bottom pb-3 px-3">
      ...
      <div class="d-grid my-3">
        <button class="btn btn-lg text-black fw-bold bg-danger border-0 py-2" type="button" onClick={async()=>{
