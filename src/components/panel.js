    ...
    <div className="container-fluid">
        <div className="row">
          ...
          <nav className="navbar bg-black">
            ...
            <nav className="nav flex-column fw-bolder">
                <a className="nav-link text-warning fw-bolder bg-dark border-none rounded-2 my-2 py-3" href="#" onClick={()=>{
                setiframe("/admin/h")
                }}>HOME</a>
                <a className="nav-link text-warning fw-bolder bg-dark border-none rounded-2 mb-2 py-3" href="#"onClick={()=>{
                setiframe("/admin/rs")
                ...
                <a className="nav-link text-warning fw-bolder bg-dark border-none rounded-2 mt-2 py-3" href="#"onClick={()=>{
                setiframe("/admin/g")
                }}>GALLERY</a>
                <a className="nav-link text-warning fw-bolder bg-dark border-none rounded-2 mt-2 py-3" href="#"onClick={()=>{
                setiframe("/admin/bm")
          ...
          <div className="col-sm-10 mx-0 px-0 border border-dark" align="center">
            <nav className="navbar bg-black border-bottom">
              <div className="container-fluid fw-bolder py-4" >
